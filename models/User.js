...
var User = {  
    ...
    updateUser: function(id, User, callback) {  
        return db.query("update User set first_name=?,last_name=?,email=?,password=?,id_status_user=?,id_school=? where id_user=?", [User.first_name, User.last_name, User.email, User.password, User.id_status_user, User.id_school, id], callback);  
    }  
};  
module.exports = User;  